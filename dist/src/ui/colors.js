...
export function statusColor(status, color) {
...
export function priorityColor(id, label) {
...
export function priorityColorInk(id) {
    switch (id) {
...
export function priorityLabelFromId(id) {
    switch (id) {
...
export function statusColorInk(status) {
    const s = status.toLowerCase();
    if (s.includes('done') || s.includes('complete') || s.includes('closed'))
        return 'green';
    if (s.includes('progress') || s.includes('active'))
