...
export default function TaskDetail({ task, compact = false, comments, loadingComments }) {
    if (!task) {
        return (_jsx(Box, { flexDirection: "column", paddingX: 1, paddingY: 1, children: _jsx(Text, { color: "gray", dimColor: true, children: "Select a task to view details" }) }));
    }
